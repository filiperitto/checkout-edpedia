...
$(document).ready(function() {
    $("#name").blur(function(){marcaEvento('#name','pagamento','preenchimento')});
    ...
    $("#email_confirm").blur(function(){marcaEvento('#email_confirm','pagamento','preenchimento')});
    ...
    $("#holdername_c").blur(function(){marcaEvento('##oldername_c','pagamento','preenchimento')});
    ...
    $("#cvv_c").mask("000").blur(function(){marcaEvento('cvv_c','pagamento','preenchimento')});
    
    
// código tiara //

    function marcaEvento(nome,pagina,tipo_evento){
        let urlGet = "http://wap.toing.com.br/landingcc/marcaEventoPagina.php";
        $.get( urlGet, { id_evento: "##ID_EVENTO##", pagina: pagina, origem: "##ORIGEM##", parceiro: "##ID_PARCEIRO##", tipo_evento:tipo_evento, nome_campo: nome } )
        .done(function( data ) {
        ...
        if(validacep.test(cep)) {
            ...
            $.getJSON("https://viacep.com.br/ws/"+ cep +"/json/?callback=?", function(dados) {
                if (!("erro" in dados)) {
                    ...
                    $("#uf").val(dados.uf);
                    marcaEvento('cep','pagamento','preenchimento');
                }else{
